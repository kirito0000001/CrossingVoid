...
#define MONGOC_USER_SET_CFLAGS "-fPIC  -DNO_ADDRESS=0 -Du_char=uint8_t -Du_short=uint16_t -Du_long=uint64_t -Du_int=uint32_t -D_SC_NPROCESSORS_ONLN=58"

#define MONGOC_USER_SET_LDFLAGS "-lresolv"
